...
async function fetchData(){
    ...
    console.log("mmr");
    try {
        const res = await axios.get("https://api.henrikdev.xyz/valorant/v1/mmr-history/ap/OPACAkh1l/2296");
...
if(mmr.length>0){
    ...
    return (
        <div className="upper-search">
             <Button type='button' buttonType='google' onClick={()=>navigate("/akhmatch")} >Match Details</Button> 
            <h1> OPAC Akhils's MMR History of the last competitive matches!!</h1>
 {ifNoData}
