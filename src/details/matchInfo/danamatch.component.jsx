...
const DanaMatch = () =>{
    ...
    async function fetchData(){
        console.log("rank")
        try {
            const res = await axios.get("  https://api.henrikdev.xyz/valorant/v3/matches/ap/opac%20criminal/mkl");
    ...
    if(match.length>0){
        ...
        return (
            <div className="upper-search">
                <Button type='button' buttonType='google' onClick={()=>navigate("/danmmr")} >Go to mmr</Button> 
                <h1> OPAC Criminals's last 5 matches info.</h1>
     {ifNoData}
