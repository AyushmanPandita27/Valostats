...
import Leaderboard from './leaderboardasia.component';
...
const LeaderboardNa = ()=>{
    ...
    async function fetchData(){
        ...
        console.log("na");
        try {
            const res = await axios.get("https://api.henrikdev.xyz/valorant/v1/leaderboard/na");
            setLdr(res.data);
        } catch (error) {
    ...
    if(ldr.length>0){
        ...
        <div className="categories-container">
          ...
          <Button type='button' buttonType='google' onClick={()=>navigate("/ldr")} >A/P</Button>
...
//na
     ...
     <input  type = 'text' placeholder='NORTH AMERICA LEADERBOARD' onChange={(event)=>{
